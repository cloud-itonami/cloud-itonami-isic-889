# Operator Quickstart — Other Social Work Activities without Accommodation

Shortest path from clone to a verified local dry-run for **ISIC 889** (`cloud-itonami-isic-889`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-889.git
cd cloud-itonami-isic-889
```
...
- Blueprint governor key: `socialwork-governor`
- Likely source path: `socialworkops.governor.cljc`
